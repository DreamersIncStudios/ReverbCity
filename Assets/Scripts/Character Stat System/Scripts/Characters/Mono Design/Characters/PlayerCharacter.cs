...
namespace Stats
{
    ...
    public class PlayerCharacter : BaseCharacter
    {
        ...
        public override void TakeDamage(int Amount, TypeOfDamage typeOf, ElementName element = 0)
        {
        ...
        public override void ReactToHit(float impact, Vector3 Test, Vector3 Forward, TypeOfDamage typeOf = TypeOfDamage.Melee, ElementName element = ElementName.None)
        {
