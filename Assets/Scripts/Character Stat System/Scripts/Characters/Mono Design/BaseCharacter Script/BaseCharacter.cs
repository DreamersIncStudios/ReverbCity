...
namespace Stats
{
    ...
    public  abstract partial class BaseCharacter : MonoBehaviour
    {
        ...
        public abstract void TakeDamage(int Amount, TypeOfDamage typeOf, ElementName element);
        public abstract void ReactToHit(float impact, Vector3 Test, Vector3 Forward, TypeOfDamage typeOf = TypeOfDamage.Melee, ElementName element = ElementName.None);
    }
