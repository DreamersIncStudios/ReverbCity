...
namespace MotionSystem.Components
{
    public struct CharControllerE : IComponentData
    {
        ...
        public float
            m_RunCycleLegOffset; //specific to the character in sample assets, will need to be modified to work with others
    ...
    public struct CombatCapable : IComponentData
    {
    }
    ...
    {
        [Header("Weapon Specs")] public float EquipResetTimer;
        [Header("Animation Movement Specs")] public float MovingTurnSpeed;
        public float StationaryTurnSpeed;
        public float JumpPower;
        [Range(1f, 4f)] public float GravityMultiplier;

        public float
            RunCycleLegOffset; //specific to the character in sample assets, will need to be modified to work with others
