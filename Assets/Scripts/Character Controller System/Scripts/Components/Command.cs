...
namespace DreamersInc.ComboSystem
{
    ...
    public class Command : IComponentData
    {
        ...
        public bool TakeInput => (WeaponIsEquipped || BareHands) && !QueueIsEmpty &&
                                 StateInfo.normalizedTime > currentStateExitTime;

        public bool TransitionToLocomotion => !StateInfo.IsTag("Locomotion") && StateInfo.normalizedTime > .95f;
        public bool CanInputAbilities => InputTimer >= 0.0f;
    }
}