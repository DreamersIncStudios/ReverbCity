...
namespace DreamersInc.ComboSystem
{
    ...
    public enum AttackType
    {
        ...
        LightAttack=1,
        HeavyAttack=2,
        ChargedLightAttack=4,
        ChargedHeavyAttack=8,
        Projectile=16,
        ChargedProjectile=32,
        Grounded=64, Targeted_Locomation=128, Locomation_Grounded_Weapon=256,
        SpecialAttack=512, Defend=1024, Dodge=2048
