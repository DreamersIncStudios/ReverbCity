...
namespace DreamersInc.InfluenceMapSystem
{
    public struct Perceptibility : IComponentData
    {
        ...
        float visibiltyScore =>
            visibilityStates switch
            {
                ...
                _ => throw new ArgumentOutOfRangeException(nameof(visibilityStates),
                    $"Not expected Vision value: {visibilityStates}"),
            };
    ...
    public partial class ChangePerceptionSystem : SystemBase
    {
        protected override void OnUpdate()
        {
            ...
            Entities.WithBurst().ForEach((Entity entity, int entityInQueryIndex, ref Perceptibility perception,
                ref ChangePerceptiopnStates change) =>
            {
